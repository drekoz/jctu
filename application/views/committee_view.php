          ...
          <div class="row header">
            ...
            <nav class="nav nav-header" id="nav">
                <ul class="topnav" id="menu">
                    <li><a href="<?= base_url(); ?>">Home</a></li>
                    <li>|</li>
                    <li class="active"><a href="<?= base_url().'committee'; ?>">Committee and Review Board</a></li>
                    <li>|</li>
                    <li><a href="<?= base_url().'schedule'; ?>">Schedule</a></li>
                    <li>|</li>
                    <li><a href="<?= base_url().'useful'; ?>">Useful Information</a></li>
        ...
        <div class="cover-container">
          ...
          <div class="row">
              ...
              <?php 
                        ...
                        {
                             if($content['section'] == 'committee')
                             {
                                 $committeecontent['topic'] = $content['topic'];
                                 $committeecontent['subtopic'] = $content['subtopic'];
                                 $committeecontent['body'] = $content['body'];
                             } 
                             else if($content['section'] == 'panel reader')
                            {
                                 $readercontent['topic'] = $content['topic'];
                                 $readercontent['subtopic'] = $content['subtopic'];
                                 $readercontent['body'] = $content['body'];
                             } 
                             else if($content['section'] == 'keynote speaker')
                            {
                                 $speakercontent['topic'] = $content['topic'];
                                 $speakercontent['subtopic'] = $content['subtopic'];
                                 $speakercontent['body'] = $content['body'];
                             }
                        }     
                ?>
            ...
            <div class="master-content-padding">
                ...
                <h1 class="cover-heading master-content-heading">
                        <?php echo $committeecontent['topic']; ?>
                    </h1>
                <p class="master-content-sub-heading">
                        <?php echo $committeecontent['subtopic']; ?>
                </p>
                <p class="lead master-content-detail">
                        <?php echo nl2br($committeecontent['body']); ?>
                </p>
            ...
            <h1 class="cover-heading master-content-heading">
            <?php echo $readercontent['topic']; ?>
            </h1>
            <p class="master-content-sub-heading">
                    <?php echo $readercontent['subtopic']; ?>
            </p>
            <p class="lead master-content-detail">
                    <?php echo nl2br($readercontent['body']); ?>
            </p>
            ...
            <h1 class="cover-heading master-content-heading">
            <?php echo $speakercontent['topic']; ?>
            </h1>
            <p class="master-content-sub-heading">
                    <?php echo $speakercontent['subtopic']; ?>
            </p>
            <p class="lead master-content-detail">
                    <?php echo nl2br($speakercontent['body']); ?>
            </p>
