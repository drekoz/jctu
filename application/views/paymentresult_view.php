    ...
    <div class="content master-container">
        <div class="cover-container">
          ...
          <div class="row">
            ...
            if($resultResponse == 'approved')
            {
                ?>
                
                <h1 class="cover-heading master-content-heading">Payment Completed</h1>
                ...
                <?php
            }else if($resultResponse == 'canceled')
            {
                ?>
                
                <h1 class="cover-heading master-content-heading">Payment Canceled</h1>
                ...
                <h1 class="cover-heading master-content-heading">Payment not success</h1>
            
                <p class="lead master-content-detail">
                    Please contact jctuconference@gmail.com for further information.
                    <br>
                    message : <?php echo $resultResponse; ?>
                </p>
