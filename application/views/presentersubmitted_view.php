    ...
    <div class="content master-container">
        <div class="cover-container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
            <p class="master-content-sub-heading registration-topic">Paper submitted.</p> 
            <p class="master-content-sub-heading registration-topic">Welcome to JCTU International Conference</p>
            <p class="master-content-detail registration-topic">Your registration has been completed.
                <br>We will get back to you soon after received the response from the reviewer.
            </p>
            </div>
            </div>
